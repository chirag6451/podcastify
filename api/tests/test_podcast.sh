...
register_response=$(curl -s -X POST "http://localhost:8011/api/v1/users/register" \
...
login_response=$(curl -s -X POST "http://localhost:8011/api/v1/users/login" \
  -H "Content-Type: application/json" \
  -d "$login_payload")
...
create_group_response=$(curl -s -X POST "http://localhost:8011/api/v1/podcasts/groups" \
  -H "Content-Type: application/json" \
...
get_groups_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/groups" \
  -H "Authorization: Bearer $token")
...
get_group_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/groups/$group_id" \
  -H "Authorization: Bearer $token")
...
update_group_response=$(curl -s -X PUT "http://localhost:8011/api/v1/podcasts/groups/$group_id" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
...
create_podcast_response=$(curl -s -X POST "http://localhost:8011/api/v1/podcasts" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
  -d "$podcast_payload")
...
get_podcasts_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts" \
  -H "Authorization: Bearer $token")
...
get_podcast_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/$podcast_id" \
  -H "Authorization: Bearer $token")
...
update_podcast_response=$(curl -s -X PUT "http://localhost:8011/api/v1/podcasts/$podcast_id" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
...
create_episode_response=$(curl -s -X POST "http://localhost:8011/api/v1/podcasts/episodes" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
  -d "$episode_payload")
...
get_episodes_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/episodes?podcast_id=$podcast_id" \
  -H "Authorization: Bearer $token")

echo "Get episodes response: $get_episodes_response"
check_response "$get_episodes_response" "id" "Failed to get episodes" || exit 1

# Get specific episode
print_header "GET SPECIFIC EPISODE"
get_episode_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/episodes/$episode_id" \
  -H "Authorization: Bearer $token")
...
update_episode_response=$(curl -s -X PUT "http://localhost:8011/api/v1/podcasts/episodes/$episode_id" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
...
create_config_response=$(curl -s -X POST "http://localhost:8011/api/v1/podcasts/platform-configs" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
  -d "$config_payload")
...
get_configs_response=$(curl -s -X GET "http://localhost:8011/api/v1/podcasts/platform-configs?podcast_id=$podcast_id" \
  -H "Authorization: Bearer $token")

echo "Get platform configs response: $get_configs_response"
check_response "$get_configs_response" "id" "Failed to get platform configs" || exit 1
...
update_config_response=$(curl -s -X PUT "http://localhost:8011/api/v1/podcasts/platform-configs/$config_id" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $token" \
...
# delete_config_response=$(curl -s -X DELETE "http://localhost:8011/api/v1/podcasts/platform-configs/$config_id" \
#   -H "Authorization: Bearer $token" -v)
# echo "Delete platform config response code: $?"

# # Delete episode
# print_header "DELETE EPISODE"
# delete_episode_response=$(curl -s -X DELETE "http://localhost:8011/api/v1/podcasts/episodes/$episode_id" \
#   -H "Authorization: Bearer $token" -v)
# echo "Delete episode response code: $?"

# # Delete podcast
# print_header "DELETE PODCAST"
# delete_podcast_response=$(curl -s -X DELETE "http://localhost:8011/api/v1/podcasts/$podcast_id" \
#   -H "Authorization: Bearer $token" -v)
# echo "Delete podcast response code: $?"

# # Delete podcast group
# print_header "DELETE PODCAST GROUP"
# delete_group_response=$(curl -s -X DELETE "http://localhost:8011/api/v1/podcasts/groups/$group_id" \
#   -H "Authorization: Bearer $token" -v)
