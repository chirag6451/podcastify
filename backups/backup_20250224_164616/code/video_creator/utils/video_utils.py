...
def create_final_video_from_paths(video_paths: dict, config: dict, job_id: int, customer_id: str, theme: str, profile: str) -> str:
    """
    ...
    Args:
        ...
        customer_id: Customer ID to include in the output filename
