    ...
    try:
        ...
        for video in pending_videos:
            ...
            try:
                ...
                video_config = video_db.get_video_config(job_id)
                ...
                # Get config and ensure output directory exists
                config = video_config['video_config']
                output_dir = config.get('output_dir', 'output')
                os.makedirs(output_dir, exist_ok=True)
                
                # Set final video filename
                config['final_video_output_filename'] = f'final_video_{job_id}.mp4'
